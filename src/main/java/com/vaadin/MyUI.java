...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        Pelaaja pelaaja= new Pelaaja("Simo", kartta.getKartta().get(0));
        ArrayList<Solmu> sallitut= pelaaja.sallitutSolmut(2);
        for(Solmu s: sallitut){
            GoogleMapMarker mark= s.getMarker();
            mark.setIconUrl("VAADIN/tinakuppi.jpg");
        }
//        Solmu testi= new Solmu(new GoogleMapMarker("koti", new LatLon(60.451863,22.282290), false, "VAADIN/red-circle.png"));
//        googleMap.addMarker(testi.getMarker());
